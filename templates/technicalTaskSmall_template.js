function htmlTechnicalTaskSmall(element) {
  return /*HTML*/ `
      <div id="${element[1]["id"]}" draggable="true" ondragstart="startDraggin(${element[1]["id"]}, event)" onclick="openTask(${element[1]["id"]})" ontouchstart="addStart(event)" class="d-flex dflex-col smallTask">
      ...
      <div id="menuContainer${element[1]["id"]}" class="menuContainer">
      <div onclick="moveCategoryInFirebase(event,'toDo',${element[1]['id']})" class="menuButton">ToDo</div>
      <div onclick="moveCategoryInFirebase(event,'inProgress',${element[1]['id']})" class="menuButton">inProgress</div>
      <div onclick="moveCategoryInFirebase(event,'awaitFeedback',${element[1]['id']})" class="menuButton">AwaitFeedback</div>
      <div onclick="moveCategoryInFirebase(event,'done',${element[1]['id']})" class="menuButton">Done</div>
    </div>
    </div>
