function editTaskBoard(task, date) {
  return /*HTML*/ `
      ...
      <div class="title-description-assigned-container">
        ...
        <div class="prio-container">
          ...
          <div class="prio-buttons">
            <button id="urgent" class="urgent-medium-low-buttons">Urgent <img src="./assets/img/prio_urgent.svg" /></button>
            <button id="medium" class="urgent-medium-low-buttons">Medium <img src="./assets/img/prio_medium.svg" /></button>
            <button id="low" class="urgent-medium-low-buttons">Low <img src="./assets/img/prio_low.svg" /></button>
          </div>
        </div>
        <div class="title-description-assigned">
        ...
        <div class="subtasks-container">
          ...
          <div class="subtasks-input-add-container">
            <input class="subtasks-input" id="subtasks-input" type="text" placeholder="Add new subtask" />
            <img class="add-subtask" src="./assets/img/add_dark.svg" />
          </div>
        </div>
      </div>
